...
globalkeys = gears.table.join(
	...
	awful.key(
		...
		"space",
		function()
			awful.util.spawn_with_shell("rofi -modi window,drun -show drun -show-icons")
		end,
	...
	awful.key(
		...
		function()
			awful.util.spawn_with_shell("amixer -D pulse set Master 5%+")
		end
	),
	awful.key(
		{},
	...
	awful.key(
		...
		"Print",
		function()
			awful.util.spawn_with_shell("maim -f png -u -m 1 -s | xclip -t image/png -in -sel c")
		end
	),
	awful.key(
		{"Shift"},
		"Print",
		function()
			awful.util.spawn_with_shell("maim -f png -u -m 1 -i $(xdotool getwindowfocus) | xclip -t image/png -in -sel c")
		end
	),
	awful.key(
		{},
		"Print",
		function()
			awful.util.spawn_with_shell("maim -f png -u -m 1 | xclip -t image/png -in -sel c")
		end
	)
)
